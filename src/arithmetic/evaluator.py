"""
Tokenizer, parser, and evaluator for canonical arithmetic expressions.
...
Supports:
  ...
  - Integer (floor) division; raises ExpressionError on division by zero
"""
...
def evaluate(expression: str) -> int:
    """
    Parse and evaluate a canonical arithmetic expression string.
